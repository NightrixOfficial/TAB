...
import net.effectsmp.tablist.listener.ScoreboardTeamGuardListener;
...
public final class TablistPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new ScoreboardTeamGuardListener(tabListManager), this);
