...
public class TabListManager {
    ...
    public void removePlayer(Player player) {
        ...
        // Look up whatever team they're actually on right now rather than
        // trusting the (possibly stale) cache - same reasoning as
        // applySortingTeam above.
        Scoreboard scoreboard = Bukkit.getScoreboardManager().getMainScoreboard();
